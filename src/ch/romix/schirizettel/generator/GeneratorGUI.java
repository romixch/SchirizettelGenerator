...
public class GeneratorGUI {
	...
	public GeneratorGUI() throws ClassNotFoundException, InstantiationException, IllegalAccessException,
	...
	private void chooseLookAndFeel() throws ClassNotFoundException, InstantiationException, IllegalAccessException,
			UnsupportedLookAndFeelException {
	...
	protected void generateReport() {
		...
		if (outputFile.exists()) {
			int confirm = JOptionPane.showConfirmDialog(frame, "Ausgabe-Datei existiert bereits. Überschreiben?",
